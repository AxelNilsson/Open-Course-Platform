...
impl User {
    pub fn from_username(conn: &MysqlConnection, username: String) -> Result<User, diesel::result::Error> {
        users::table
...
impl Ticket {
    pub fn for_user(conn: &MysqlConnection, username: String) -> Result<Vec<Ticket>, diesel::result::Error> {
        tickets::table
        .filter(users::username.eq(username))
...
impl TicketWithResponse {
    pub fn for_ticket(conn: &MysqlConnection, username: String, ticket_id: u64) -> Result<TicketWithResponse, diesel::result::Error> {
...
impl NewUser {
    pub fn insert(conn: &MysqlConnection, user: NewUser) -> Result<usize, diesel::result::Error> {    
...
impl Password {
    pub fn update(&self, conn: &MysqlConnection, username: String) -> Result<usize, diesel::result::Error> {    
